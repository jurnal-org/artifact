...
const DEV_EMAIL = "tendeturchesi@gmail.com";
const DEV_NAME = "Giacomo";
...
const days = [
  {
    ...
    summary:
      "Giacomo ha iniziato la giornata sentendosi un po' stanco dopo un weekend intenso. Ha parlato del ritorno alla routine lavorativa e di come stia cercando di organizzare meglio le sue giornate. Nonostante la stanchezza, ha espresso una certa calma nell'affrontare la settimana.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giacomo ha affrontato una giornata lavorativa impegnativa con diverse deadline ravvicinate. Ha espresso frustrazione per un progetto che procede a rilento, ma anche determinazione nel portarlo a termine. Ha menzionato la necessità di parlare con il cliente per riallineare le aspettative.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "La call con il cliente è andata molto bene. Giacomo è riuscito a comunicare chiaramente i limiti e le tempistiche, ottenendo un accordo su specifiche definitive. Si sente sollevato e soddisfatto della sua assertività. Ha anche fatto una corsa serale che lo ha aiutato a scaricare la tensione.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giornata tranquilla in cui Giacomo ha riflettuto sul suo rapporto con il lavoro. Ha notato che tende a portarsi lo stress a casa e vuole lavorare su questo aspetto. Ha parlato dell'importanza di avere hobby fuori dal lavoro e del fatto che ha ripreso a leggere.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giacomo ha parlato dei genitori che vivono lontano e della nostalgia che prova. Non li vede da un mese e si sente in colpa per non chiamarli abbastanza spesso. Ha deciso di organizzare una visita per il prossimo weekend.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giornata molto produttiva. Giacomo ha completato una feature importante del progetto e si sente in flow. Ha anche avuto una buona idea per un side project personale legato all'AI. L'energia è alta e il focus buono.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Serata piacevole con amici. Giacomo ha cenato con Sara e Luca, vecchi compagni di università. Hanno parlato di ricordi e progetti futuri. Si sente grato per le amicizie che durano nel tempo.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giacomo si sente ansioso per una presentazione importante che deve fare la prossima settimana al cliente. Non si sente preparato e teme di non riuscire a comunicare bene il valore del lavoro fatto. L'ansia gli sta rovinando la concentrazione.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giacomo è andato a trovare i genitori come aveva programmato. Una giornata bellissima, hanno cucinato insieme e fatto una passeggiata. Si sente rigenerato e sereno. La mamma gli ha dato un barattolo della sua marmellata fatta in casa.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Dopo il weekend con la famiglia, Giacomo si sente motivato per la settimana. Ha scritto i suoi obiettivi e si sente più chiaro su dove vuole andare sia nel lavoro che nella vita. Ha anche iniziato a meditare la mattina.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giornata faticosa con un bug difficile da risolvere che ha occupato tutta la mattina. Giacomo ha avuto momenti di dubbio sulle sue capacità, ma ha poi trovato la soluzione. Riflette sulla pazienza necessaria nel lavoro tecnico.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "La presentazione al cliente è andata benissimo! Il cliente era entusiasta del lavoro e ha fatto i complimenti. Giacomo si sente orgoglioso e sollevato. Ha celebrato con una birra dopo il lavoro.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giornata di relax dopo il successo della presentazione. Giacomo ha fatto una passeggiata al parco e ha letto per un'ora su una panchina. Sente di aver trovato un buon equilibrio tra impegno e riposo.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giornata tesa. Giacomo ha avuto un disaccordo con un collega sulla direzione tecnica di un progetto. Si sente frustrato perché non riesce a far passare le sue idee. Ha bisogno di trovare un modo migliore per comunicare.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giacomo e Andrea hanno parlato e trovato un compromesso. Si sono resi conto che entrambi avevano punti validi. Giacomo apprezza la maturità di entrambi nel risolvere il conflitto. Ha anche fatto la seconda corsa della settimana.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giacomo si sente solo oggi. I piani per la serata sono saltati e si ritrova a casa da solo. Riflette sul fatto che nonostante abbia amici, a volte sente la mancanza di una relazione. Non è una tristezza acuta, più una malinconia di fondo.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giacomo si è svegliato con più energia dopo la serata riflessiva. È andato a correre la mattina e ha raggiunto un nuovo personal best sui 5km. Lo sport lo ha aiutato a riconnettersi con se stesso e a ritrovare positività.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giacomo ha dedicato la serata al side project AI. Ha creato un prototipo funzionante e si sente ispirato. È entusiasta delle possibilità e vuole dedicarci più tempo. La creatività fuori dal lavoro lo ricarica.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giornata nella media, né positiva né negativa. Giacomo sente la fatica della routine settimanale. Ha meditato la mattina e nota che l'abitudine sta diventando più naturale. Accetta che non tutte le giornate devono essere speciali.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giornata inaspettatamente bella. Un vecchio amico di liceo, Davide, lo ha contattato dopo anni. Hanno parlato al telefono per un'ora rivivendo ricordi. Giacomo riflette su come le connessioni importanti resistano al tempo.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giacomo ha mal di schiena da qualche giorno e oggi è peggiorato. Non riesce a lavorare bene e si preoccupa perché non può correre. Ha deciso di prenotare un fisioterapista. La frustrazione per i limiti fisici lo mette di cattivo umore.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Ha prenotato il fisioterapista per venerdì. Il mal di schiena è un po' meglio ma ancora presente. Giacomo pratica la pazienza che sta imparando dal libro stoico. Ha lavorato da casa per stare più comodo.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giacomo ha avuto una bella conversazione con Sara che gli ha dato prospettiva sui suoi problemi. Si rende conto che tende ad amplificare le difficoltà. La schiena migliora e si sente grato per le piccole cose.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "La visita dal fisioterapista è andata bene. Ha una contrattura muscolare risolvibile con esercizi mirati. Giacomo è sollevato che non sia nulla di grave. Ha ripreso a meditare con costanza.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Weekend splendido. Giacomo è andato a fare una gita al lago con Marco. Tempo perfetto, hanno fatto un picnic e parlato di vita. Si sente felice e in pace. Il mal di schiena è quasi passato.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giacomo inizia la settimana con energia. Ha pianificato bene le giornate e si sente ottimista. Il progetto del cliente è in fase finale e il side project AI sta progredendo. Ha ripreso la meditazione mattutina dopo averla saltata nel weekend.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Il progetto del cliente è stato consegnato! Il cliente è soddisfatto e ha già parlato di un possibile follow-up. Giacomo si sente orgoglioso del percorso fatto, ricordando l'ansia iniziale e i problemi lungo la strada. Ha celebrato con una cena fuori.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Dopo la consegna del progetto, Giacomo si sente in uno stato di transizione. Non ha ancora un nuovo progetto principale e si chiede su cosa concentrarsi. Riflette sul bisogno di prendersi una pausa prima di buttarsi nel prossimo impegno.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giacomo ha ripreso a correre dopo la pausa forzata per la schiena. Non ha forzato i tempi ma si è goduto il movimento. Si sente libero e grato. Ha anche lavorato al side project con risultati promettenti.",
    messages: [
  ...
  },
  {
    ...
    summary:
      "Giornata equilibrata e serena. Giacomo sente di aver trovato un buon ritmo tra lavoro, sport, meditazione e creatività. Riflette sul mese passato e su quanto sia cresciuto. Si sente grato per il percorso fatto.",
    messages: [
...
async function seed() {
  ...
  console.log(`User: ${DEV_NAME} (${USER_ID})`);
  ...
  console.log("Cleaned existing sessions/facts");
  ...
  // Summary
  const [sessionCount] = await sql`SELECT COUNT(*) as c FROM sessions WHERE user_id = ${USER_ID}`;
  ...
  console.log(`\nDone! ${sessionCount.c} sessions, ${msgCount.c} messages, ${factCount.c} facts`);
  console.log(`\nDev login: ${DEV_EMAIL}`);
}
